...
VALUES (1,'Single(no jacuzzi)',149.99,NULL),
    ...
    (3,'Double(no jacuzzi)',174.99,10.00),
    (4,'Double(with jacuzzi)',199.99,10.00),
    (5,'Suite',399.99,20.00);
...
VALUES (1,16,2,1,0,'2023-02-02','2023-02-04',299.98),
    ...
    (24,9,2,2,2,'2022-11-22','2023-11-25',599.97),
